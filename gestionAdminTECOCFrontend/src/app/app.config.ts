...
import { ImplementosDisponiblesHttpApi } from './core/loans/implementos-disponibles-http.api';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    { provide: ImplementosDisponiblesApi, useClass: ImplementosDisponiblesHttpApi },
